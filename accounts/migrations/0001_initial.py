    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('beds24_subaccount_id', models.CharField(blank=True, max_length=100)),
            ...
            options={
                'db_table': 'users',
                'indexes': [models.Index(fields=['email'], name='users_email_4b85f2_idx'), models.Index(fields=['user_type'], name='users_user_ty_578f8f_idx'), models.Index(fields=['status'], name='users_status_9ca66f_idx'), models.Index(fields=['beds24_subaccount_id'], name='users_beds24__d6bd9f_idx')],
            },
            managers=[
